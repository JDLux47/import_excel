TABLE_CONFIGS = {
    ...
    'Price ATOL 2025-04-14 (Золото).xlsx': {
        ...
        'header': 10,
        'columns': ['article', 'short_name', 'category', 'rrc_price', 'price', 'is_promo', 'promo', 'parameters', 'chunk', 'embedding'],
        'chunk': ['short_name', 'category'],
        'types':["принтер", "модуль", "терминал", "лицензия", "ккт", "аккумулятор", "ксо", "весы", "ключ", "рычаг", "ограничитель", "моноблок",
                "уплотнитель", "механизм", "разделитель", "крэдл", "ритейл", "бутик", "тумба", "полка", "держатель", "разъем", "аксессуар",
                "касс", "pos", "ридер", "ящик", "клавиатура", "дисплей", "сканер", "по", "крышка", "кабель", "блок", "антенна", "пин-пад",
                "камера", "ножка", "ручка", "динамик", "frontol", "клеверенс", "optima", "jazz", "чехол", "бампер", "ремешок", "пин пад",
                "панель", "плата", "шестеренка", "датчик", "пружина", "кнопка", "корпус", "диск", "ось", "датчик", "фиксатор", "стойка",
