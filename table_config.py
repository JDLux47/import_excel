...
TABLE_CONFIGS = {
    ...
    'Price ATOL 2025-04-14 (Золото).xlsx': {
        ...
        'types':["принтер", "модуль", "терминал", "лицензия", "ККТ", "аккумулятор", "КСО", "весы", "ключ", "рычаг", "ограничитель",
                ...
                "касса", "POS", "ридер", "ящик", "клавиатура", "дисплей", "сканер", "ПО", "крышка", "кабель", "блок", "антенна",
                ...
                "двигатель", "шлейф", "рамка", "комплект", "монитор", "компьютер", "Selfie", "МАКС", "планшет", "вставка", "стекло"],
        'excel_column_map': {
            "Код": "article",
            "Товар": "short_name",
